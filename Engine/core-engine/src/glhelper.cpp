...
//
//    GLubyte const * str_details = glGetString(GL_RENDERER);
//    std::cout << "GL Renderer: " << str_details << std::endl;
//    
//    str_details = glGetString(GL_VERSION);
//    std::cout << "GL Version: " << str_details << std::endl;
//
//    str_details = glGetString(GL_SHADING_LANGUAGE_VERSION);
//    std::cout << "GL Shader Version: " << str_details << std::endl;
//
//    GLint int_version;
//    glGetIntegerv(GL_MAJOR_VERSION, &int_version);
//    std::cout << "GL Major Version: " << int_version << std::endl;
//
//    glGetIntegerv(GL_MINOR_VERSION, &int_version);
//    std::cout << "GL Minor Version: " << int_version << std::endl;
//    
//    GLint context;
//    glGetIntegerv(GL_DOUBLEBUFFER, &context);
//    if(context)
//        std::cout << "Current OpenGL Context is double buffered" << std::endl;
//    
//
//    GLint tex_size, count;
//
...
//
//    glGetIntegerv(GL_MAX_VIEWPORT_DIMS, &count);
//    std::cout << "Maximum Viewport Dimensions: " << count << " x " << count << std::endl;
}
