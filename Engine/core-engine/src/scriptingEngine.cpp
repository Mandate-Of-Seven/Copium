...
namespace Copium::ScriptingEngine
{
	...
	std::list<ScriptFile*> scriptFiles;
	...
	std::thread* compilerThread = nullptr;
	...
	FieldType GetType(MonoType* monoType)
	{
