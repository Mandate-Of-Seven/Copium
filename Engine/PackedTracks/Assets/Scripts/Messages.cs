	...
	public static class Event_Bomb
	{
		...
		public static class ChuckHealthy
		{
			public const string body =
                ...
                "Chuck called a meeting of the remaining crew members to discuss next steps. As Chuck made his way through the train on his routine patrol, he heard a faint, steady bleeping sound emanating from the engine room. " +
		...
		public static class CrewInjured
		{
			public const string body =
                ...
                "He could hear the panicked cries of his fellow crew members as they desperately tried to keep the train from derailing completely. But despite their best efforts, the train ground to a halt, shuddering to a stop in the middle of nowhere. " +
                "The darkness outside was absolute, and the silence that followed the explosion was deafening. Danton knew that something was horribly wrong.The train was dead in the water, with no power and no means of communication. " +
